                        ...
                        if (response.productos[i].idpedidorelacion == idpedido)
                        {
                            ...
                            if(tracking_number == null)
                            {
                                ...
                                if(response2.mensaje == "La guia fue asignada al pedido correctamente")
                                {
                                    ...
                                    UpdCSOrders = point.UpdSROrders(idpedido,tracking_number2,estatusguia);
                            ...
                            else
                            {
                                ...
                                UpdCSOrders = point.UpdSROrders(sale_order_id, tracking_number, estatus);
