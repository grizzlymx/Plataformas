...
using CreatedTrackingKitsSR.Services;
using MySqlConnector;
using Newtonsoft.Json;
using RestSharp;

namespace CreatedTrackingKitsSR.Model
{
    public class EndPoint
    {
        ...
        public MensajeConfirmacion PostTracking (string nopedido, string idpedido, string sku)
        {
            ...
            try
            {
                ...
                cn.EjecutaConsulta("INSERT INTO m_createdTrackingLogSR(sr_id, idpedidorelacion, seller_sku, estatus, mensaje, endpoint,request_data ,response_data, add_date, `server`) " +
                    "VALUES(@nopedido,@idpedido, @sku, @estatus, @mensaje, @ENDPOINT,@json, @respose, NOW(),'netcore Created Tracking Kits SR')", new[]
                    {
